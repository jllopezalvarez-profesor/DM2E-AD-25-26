package es.jllopezalvarez.ad.ut02conectores.ejemplos.singleton;
...
public enum EnumSingleton {
    INSTANCE; // Se puede inicializar aquí, pero suele ser mejor en constructor

    // Constructor para inicializar elmentos asociados
    private EnumSingleton() {
        // Aquí se pueden crear objetos necesarios para luego usarlos en el método de instancia
    }
